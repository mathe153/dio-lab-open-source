...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/mathe1531`: new git checkout ´git checkout -b feat/community/mathe1531´;
    > Exemplo: `git checkout -b feat/community/mathe1531`
